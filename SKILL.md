---
name: "skill-forge"
description: "技能熔炉 — 锻造/评估/发布 Skill。当用户说 技能熔炉/熔炉创建/锻造技能 时走全流程；说 技能评估/skill评估/评估技能 时只做同类比对+腾讯9维度；说 技能发布/发布技能 时只做GitHub+ClawHub推送。Do NOT use for editing existing skills, skill security vetting, or general coding tasks."
---
...
| 触发词 | 入口 | 执行流程 |
|--------|------|---------|
| 技能熔炉 / 熔炉创建 / 锻造技能 / 新建熔炉 / 熔炉技能 | Phase 0 | Phase 0→1→2→3 全流程 |
